...
/******BEGIN OF MENU INPUT******/
const { regurus } = require('./src/regurus')
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=+5581986640324:+55 (81) 98664-0324\n' // ID do WhatsApp + número de telefone
            + 'END:VCARD'
/******END OF VCARD INPUT******/
...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `𝐎 𝐏 𝐀  𝐄 𝐀 𝐄  @${num.split('@')[0]}\n𝐒 𝐄 𝐉 𝐀  𝐁 𝐎 𝐌  𝐕 𝐈 𝐍 𝐃 𝐎  𝐀 𝐎  𝐆 𝐑 𝐔 𝐏 𝐎  *${mdata.subject}* 𝐋 𝐄 𝐈 𝐀  𝐀 𝐒  𝐑 𝐄 𝐆 𝐑 𝐀 𝐒  𝐏 𝐑 𝐀  𝐍 ã𝐎  𝐒 𝐄 𝐑  𝐑 𝐄 𝐌 𝐎 𝐕 𝐈 𝐃 𝐎\n 𝐄  𝐍 ã𝐎  𝐒 𝐄 𝐉 𝐀  𝐔 𝐌  𝐆 𝐇 𝐎 𝐒 𝐓 `
				...
				teks = `Ja foi tarde kkk😂@${num.split('@')[0]} espero que tenha ido pra nao voltar`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⌛𝐂 𝐀 𝐋 𝐌 𝐀  𝐓 𝐎  𝐅 𝐀 𝐙 𝐄 𝐍 𝐃 𝐎   𝐀 𝐐 𝐔 𝐈 ⌛ 𝐀 𝐏 𝐑 𝐎 𝐕 𝐄 𝐈 𝐓 𝐀  𝐄  𝐕 𝐀 𝐈  𝐓 𝐎 𝐌 𝐀 𝐑  𝐔 𝐌  𝐂 𝐀 𝐅 𝐄 𝐙 𝐈 𝐍 𝐇 𝐎  ☺️',
				success: '😎️𝐎  𝐑 𝐀 𝐏 𝐀 𝐈 𝐙  𝐃 𝐄 𝐔  𝐁 𝐀 𝐎 😎',
                                levelon: '⚠️𝑯 𝑨 𝑩 𝑰 𝑳 𝑰 𝑻 𝑨 𝑹  𝑳 𝑬 𝑽 𝑬 𝑳 ⚠️',
				leveloff: '⚠️𝑫 𝑬 𝑺 𝑨 𝑩 𝑰 𝑳 𝑰 𝑻 𝑨 𝑹  𝑳 𝑬 𝑽 𝑬 𝑳 ⚠️',
				levelnoton: '⚠️𝑳 𝑬 𝑽 𝑬 𝑳  𝑵 Ã𝑶  𝑨 𝑻 𝑰 𝑽 𝑶 ⚠️',
				levelnol: '*Pqp kskst level* 0 ',
				error: {
					stick: '⚠️𝑬 𝑹 𝑹 𝑶  𝑨 𝑶  𝑪 𝑶 𝑵 𝑽 𝑬 𝑹 𝑻 𝑬 𝑹  𝑰 𝑴 𝑮 𝑬 𝑴 /𝑮 𝑰 𝑭 /𝑽 𝑰 𝑫 𝑬 𝑶  𝑬 𝑴  𝑨 𝑫 𝑬 𝑺 𝑰 𝑽 𝑶 ⚠️',
					Iv: '⚠️𝑳 𝑰 𝑵 𝑲  𝑰 𝑵 𝑽 𝑨 𝑳 𝑰 𝑫 𝑶 ️⚠️'
				},
				only: {
					group: '[❗] 𝐄 𝐒 𝐓 𝐄  𝐂 𝐎 𝐌 𝐀 𝐍 𝐃 𝐎  𝐒 𝐎  𝐏 𝐎 𝐃 𝐄  𝐒 𝐄 𝐑  𝐔 𝐒 𝐀 𝐃 𝐎  𝐄 𝐌  𝐆 𝐑 𝐔 𝐏 𝐎 𝐒 ❗',
					ownerG: '[❗] 𝐄 𝐒 𝐓 𝐄  𝐂 𝐎 𝐌 𝐀 𝐍 𝐃 𝐎  𝐒 𝐎  𝐏 𝐎 𝐃 𝐄  𝐒 𝐄 𝐑  𝐔 𝐒 𝐀 𝐃 𝐎  𝐏 𝐄 𝐋 𝐎  𝐃 𝐎 𝐍 𝐎  𝐃 𝐎  𝐆 𝐑 𝐔 𝐏 ❗',
					ownerB: '[❗] 𝑬 𝑺 𝑻 𝑬  𝑪 𝑶 𝑴 𝑨 𝑵 𝑫 𝑶  𝑺 𝑶  𝑷 𝑶 𝑫 𝑬  𝑺 𝑬 𝑹  𝑼 𝑺 𝑨 𝑫 𝑶  𝑷 𝑬 𝑳 𝑶  𝑲 1𝑹 1𝑻 0❗',
					admin: '[❗] 𝐄 𝐒 𝐓 𝐄  𝐂 𝐎 𝐌 𝐀 𝐍 𝐃 𝐎  𝐒 𝐎  𝐏 𝐎 𝐃 𝐄  𝐒 𝐄 𝐑  𝐔 𝐒 𝐀 𝐃 𝐎  𝐏 𝐎 𝐑  𝐔 𝐌  𝐀 𝐃 𝐌  𝐃 𝐎  𝐆 𝐑 𝐔 𝐏 𝐎 ❗',
					Badmin: '[❗] 𝐍 𝐄 𝐂 𝐄 𝐒 𝐒 𝐀 𝐑 𝐈 𝐎  𝐁 𝐎 𝐓  𝐓 𝐄 𝐑  𝐀 𝐃 𝐌  𝐏 𝐀 𝐑 𝐀  𝐅 𝐔 𝐍 𝐂 𝐈 𝐎 𝐍 𝐀 ❗ ',
                                        daftarB: `Opa eae mano !\nVoce nao ta registrado no banco de dados aqui ;-; se registra pra ter acesso aos Comandos, se registra desse jeito  \n\nComando : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar chapa|13
*Tem que usar esse simbolo '|' pra separar nome de idade*.`,
				}
			}
			...
			const ownerNumber = ["558186640324@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '558186640324@s.whatsapp.net'
                        /******ApiKey Input******/
       ...
       /******END OF FUNCTIONS INPUT******/
           switch(command) {
				case 'regurus':
				case 'helpregurus':
					client.sendMessage(from, regurus(prefix), text)
					break
			case 'timer':
               ...
               break
				case 'demote':
                  ...
                  case 'promote':
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = '⚠️𝑷 𝑬 𝑫 𝑰 𝑫 𝑶  𝑹 𝑬 𝑪 𝑬 𝑩 𝑰 𝑫 𝑶 , 𝑨 𝑫 𝑰 𝑪 𝑰 𝑶 𝑵 𝑨 𝑵 𝑫 𝑶  𝑷 𝑶 𝑺 𝑰 𝑪 𝑨 𝑶  𝑫 𝑬  𝑨 𝑫 𝑴 𝑰 𝑵 𝑰 𝑺 𝑻 𝑹 𝑨 𝑫 𝑶 𝑹  :\n'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
						mentions(teks, mentioned, true)
    ...
    client.sendMessage(from, options, text, { quoted: mek } )
			...
			case 'quotes':
              ...
              case 'owner':
               ...
               client.sendMessage(from, '𝐀 𝐐 𝐔 𝐈  𝐄 𝐒 𝐓 𝐀  𝐎  𝐍 𝐔 𝐌 𝐄 𝐑 𝐎  𝐃 𝐎  𝐌 𝐄 𝐔  𝐃 𝐎 𝐍 𝐎 , 𝐒 𝐀 𝐋 𝐕 𝐄  𝐃 𝐄 𝐏 𝐎 𝐈 𝐒 ',MessageType.text, { quoted: mek} )
                break
	case 'hidetag':
                client.updatePresence(from, Presence.composing) 
                if (!isUser) return reply(mess.only.daftarB)
              ...
              await client.sendMessage(from, options, text)
               break
					...
					try {
						...
						reply('⚠️𝑵 𝑶 𝑴 𝑬  𝑫 𝑬  𝑼 𝑺 𝑼 𝑨 𝑹 𝑰 𝑶  𝑰 𝑵 𝑽 𝑨 𝑳 𝑰 𝑫 𝑶⚠️ ')
					}
					break
				case 'snowwrite':
		...
		case 'spamcall':
               client.updatePresence(from, Presence.composing)
                ...
                break
                   ...
                   break
				case 'wiki':
					if (args.length < 1) return reply('𝑫 𝑰 𝑮 𝑰 𝑻 𝑬  𝑨  𝑷 𝑨 𝑳 𝑨 𝑽 𝑹 𝑨 -𝑪 𝑯 𝑨 𝑽 𝑬 ')
					tels = body.slice(6)	
                                        if (!isUser) return reply(mess.only.daftarB)				
				...
				case 'wikien':
					...
					break				
				case 'ytmp3':
					if (args.length < 1) return reply('𝑪 𝑨 𝑫 𝑬  𝑶  𝑳 𝑰 𝑵 𝑲  𝑻 𝑰 𝑶 ?')
	...
	case 'kbbi':
	      ...
	      tels = body.slice(6)
			...
			tels = body.slice(6)
               ...
               if (data.error) return reply(data.error)
				...
				case 'info':
					...
					break
				case 'blocklist':
					teks = '𝐍 𝐔 𝐌 𝐄 𝐑 𝐎 𝐒  𝐃 𝐄  𝐐 𝐔 𝐄 𝐌  𝐅 𝐄 𝐙  𝐌 𝐄 𝐑 𝐃 𝐀  :\n'
                   ...
                   case 'chatlist':
					client.updatePresence(from, Presence.composing)  
					teks = '𝐐 𝐔 𝐀 𝐍 𝐓 𝐈 𝐃 𝐀 𝐃 𝐄  𝐃 𝐄  𝐂 𝐇 𝐀 𝐓 𝐒  :\n'
				...
				case 'tts':
				   ...
				   if (args.length < 1) return client.sendMessage(from, '𝐐 𝐔 𝐀 𝐋  𝐄  𝐀  𝐒 𝐈 𝐆 𝐋 𝐀  𝐃 𝐄  𝐋 𝐈 𝐍 𝐆 𝐔 𝐀 𝐆 𝐄 𝐌 ?', text, {quoted: mek})
                                   if (!isUser) return reply(mess.only.daftarB)
					const gtts = require('./lib/gtts')(args[0])
					if (args.length < 2) return client.sendMessage(from, '𝐂 𝐀 𝐃 𝐄  𝐀  𝐅 𝐀 𝐋 𝐀 ?', text, {quoted: mek})
					dtt = body.slice(8)
					ranm = getRandom('.mp3')
					rano = getRandom('.ogg')
					dtt.length > 600
					? reply('𝐂 𝐀 𝐃 𝐄  𝐀  𝐅 𝐀 𝐋 𝐀 ?')
					: gtts.save(ranm, dtt, function() {
						exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
							fs.unlinkSync(ranm)
							buff = fs.readFileSync(rano)
							if (err) return reply('𝐅 𝐀 𝐋 𝐇 𝐎 𝐔  :(')
				...
				case 'setprefix':
					...
					prefix = args[0]
					reply(`𝐎  𝐏 𝐑 𝐄 𝐅 𝐈 𝐗 𝐎  𝐅 𝐎 𝐈  𝐀 𝐋 𝐓 𝐄 𝐑 𝐀 𝐃 𝐎  𝐏 𝐀 𝐑 𝐀  : ${prefix}`)
					break
				case 'meme':
				...
				client.updatePresence(from, Presence.composing) 
					...
					client.sendMessage(from, '╔══✪〘 MARCANDO TODO MUNDO QUEM NN GOSTA QUE SE FODA🤬💪 〙✪══\n╠➥'+teks+'╚═𝕽 𝕰 𝕲 𝖀 𝕽 𝖀 𝕾  𝕭 𝕺 𝕿 ', text, {detectLinks: false, quoted: mek})
					break
                        case 'tagall4':
				client.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						reply('⚠️𝑺 𝑼 𝑪 𝑬 𝑺 𝑺 𝑶  𝑵 𝑨  𝑻 𝑹 𝑨 𝑵 𝑺 𝑴 𝑰 𝑪 𝑨 𝑶 ')
					}
					break
					case 'bcgc':
					client.updatePresence(from, Presence.composing) 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						reply('⚠️𝑺 𝑼 𝑪 𝑬 𝑺 𝑺 𝑶  𝑨 𝑶  𝑮 𝑹 𝑼 𝑷 𝑶  𝑫 𝑬  𝑻 𝑹 𝑨 𝑵 𝑺 𝑴 𝑰 𝑪 𝑨 𝑶 ')
					}
					break
				case 'alay':
                    client.updatePresence(from, Presence.composing) 
					...
					client.groupLeave (from) 
                     ...
                     setTimeout( () => {
					client.updatePresence(from, Presence.composing) 
					client.sendMessage(from, '𝑻 𝑪 𝑯 𝑨 𝑼 , 𝑮 𝑯 𝑶 𝑺 𝑻  É 𝑸 𝑼 𝑬  𝑵 𝑬 𝑴  𝑳 𝑶 𝑳 𝑰 𝑪 𝑶 𝑵 , 𝑵 𝑶 𝑰 𝑺  𝑴 𝑨 𝑻 𝑨 ', text) // ur cods
					}, 0)
                     break

				case 'chord':
					if (args.length < 1) return reply('𝑪 𝑨 𝑫 𝑬  𝑶  𝑵 𝑶 𝑴 𝑬  𝑫 𝑨  𝑴 𝑼 𝑺 𝑰 𝑪 𝑨 ?')
                                        if (!isUser) return reply(mess.only.daftarB)
					tels = body.slice(7)					
					...
					break
				case 'lirik':
					if (args.length < 1) return reply('𝑪 𝑨 𝑫 𝑬  𝑨 𝑺  𝑳 𝑬 𝑻 𝑹 𝑨 𝑺 ?')
                                        if (!isUser) return reply(mess.only.daftarB)
					tels = body.slice(7)
			...
			case 'igstalk':
               ...
               client.updatePresence(from, Presence.composing) 
              options = {
          text: `𝐎  𝐃 𝐎 𝐍 𝐎  𝐃 𝐄 𝐒 𝐒 𝐄  𝐌 𝐀 𝐑 𝐀 𝐕 𝐈 𝐋 𝐇 𝐎 𝐒 𝐎  𝐆 𝐑 𝐔 𝐏 𝐎  É : @${from.split("-")[0]}`,
          contextInfo: { mentionedJid: [from] }
           ...
           break
				...
				case 'add':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('𝐐 𝐔 𝐄 𝐌  𝐕 𝐎 𝐂 𝐄  𝐐 𝐔 𝐄 𝐑  𝐀 𝐃 𝐈 𝐂 𝐈 𝐎 𝐍 𝐀 𝐑 ?')
					if (args[0].startsWith('08')) return reply('𝑼 𝑺 𝑬  𝑪 𝑶 𝑴  𝑶  𝑪 𝑶 𝑫 𝑰 𝑮 𝑶  𝑫 𝑬  𝑷 𝑨 𝑰 𝑺 ')
					try {
						num = `${args[0].replace(/ /g, '')}@s.whatsapp.net`
						client.groupAdd(from, [num])
					} catch (e) {
						console.log('Error :', e)
						reply('𝑭 𝑨 𝑳 𝑯 𝑨  𝑨 𝑶  𝑨 𝑫 𝑰 𝑪 𝑰 𝑶 𝑵 𝑨 𝑹  𝑼 𝑺 𝑼 𝑨 𝑹 𝑰 𝑶 , 𝑻 𝑨 𝑳 𝑽 𝑬 𝒁  𝑷 𝑶 𝑹 𝑸 𝑼 𝑬  É 𝑷 𝑹 𝑰 𝑽 𝑨 𝑫 𝑶 ')
					}
					break
				...
				case 'remover':
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = '𝑷 𝑬 𝑫 𝑰 𝑫 𝑶 𝑺  𝑹 𝑬 𝑪 𝑬 𝑩 𝑰 𝑫 𝑶 𝑺  𝑬  𝑬 𝑴 𝑰 𝑻 𝑰 𝑫 𝑶 𝑺  :\n'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
						mentions(teks, mentioned, true)
						...
						mentions(`𝑷 𝑬 𝑫 𝑰 𝑫 𝑶 𝑺  𝑹 𝑬 𝑪 𝑬 𝑩 𝑰 𝑫 𝑶 𝑺  𝑬  𝑬 𝑴 𝑰 𝑻 𝑰 𝑫 𝑶 𝑺  : @${mentioned[0].split('@')[0]}`, mentioned, true)
						client.groupRemove(from, mentioned)
					client.sendMessage(mentioned, '𝐈 𝐈 𝐇  𝐀 𝐋 𝐀  𝐅 𝐄 𝐙  𝐌 𝐄 𝐑 𝐃 𝐀  𝐉 𝐊 𝐊 𝐊 𝐊 ', text)
					}
					break
				case 'exe':
	              client.updatePresence(from, Presence.composing) 
				...
				case 'ocr':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						reply('𝑴 𝑨 𝑵 𝑫 𝑬  𝑪 𝑶 𝑴  𝑼 𝑴 𝑨  𝑭 𝑶 𝑻 𝑶 ')
					}
					break

                      case 'bugreport':
                     const bug = body.slice(5)
                      if (pesan.length > 300) return client.sendMessage(from, '⚠️𝐓 𝐄 𝐗 𝐓 𝐎  𝐌 𝐔 𝐈 𝐓 𝐎  𝐋 𝐎 𝐍 𝐆 𝐎 , 𝐌 𝐀 𝐗 𝐈 𝐌 𝐎  300 𝐋 𝐄 𝐓 𝐑 𝐀 𝐒 ', msgType.text, {quoted: mek})
                    ...
                    reply('⚠️𝑷 𝑹 𝑶 𝑩 𝑳 𝑬 𝑴 𝑨 𝑺  𝑭 𝑶 𝑹 𝑨 𝑴  𝑹 𝑬 𝑳 𝑨 𝑻 𝑨 𝑫 𝑶 𝑺  𝑨 𝑶  𝑷 𝑹 𝑶 𝑷 𝑹 𝑰 𝑬 𝑻 Á𝑹 𝑰 𝑶  𝑫 𝑶  𝑩 𝑶 𝑻 , 𝑹 𝑬 𝑳 𝑨 𝑻 Ó𝑹 𝑰 𝑶 𝑺  𝑭 𝑨 𝑳 𝑺 𝑶 𝑺  𝑵 𝑨 𝑶  𝑺 𝑬 𝑹 𝑨 𝑰  𝑹 𝑬 𝑺 𝑷 𝑶 𝑵 𝑫 𝑰 𝑫 𝑶 𝑺 .')
                    break
               case 'apakah':
               client.updatePresence(from, Presence.composing) 
	    ...
	    case 'kapankah':
			...
			case 'closegc':
					...
					var nomor = mek.participant
					const close = {
					text: `⚠️𝑮 𝑹 𝑼 𝑷 𝑶  𝑭 𝑶 𝑰  𝑭 𝑬 𝑪 𝑯 𝑨 𝑫 𝑶  𝑷 𝑬 𝑳 𝑶  𝑨 𝑫 𝑴  @${nomor.split("@s.whatsapp.net")[0]}\n𝑨 𝑮 𝑶 𝑹 𝑨  *𝑨 𝑷 𝑬 𝑵 𝑨 𝑺  𝑨 𝑫 𝑴 𝑺  𝑷 𝑶 𝑫 𝑬 𝑴  𝑬 𝑵 𝑽 𝑰 𝑨 𝑹  𝑴 𝑬 𝑵 𝑺 𝑨 𝑮 𝑬 𝑵 𝑺 *`,
					contextInfo: { mentionedJid: [nomor] }
					}
                ...
                case 'bukagc':
					...
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					open = {
					text: `⚠️𝑮 𝑹 𝑼 𝑷 𝑶  𝑭 𝑶 𝑰  𝑨 𝑩 𝑬 𝑹 𝑻 𝑶  𝑷 𝑬 𝑳 𝑶  𝑨 𝑫 𝑴  @${sender.split("@")[0]}\n𝑨 𝑮 𝑶 𝑹 𝑨  *𝑻 𝑶 𝑫 𝑶 𝑺  𝑶 𝑺  𝑷 𝑨 𝑹 𝑻 𝑰 𝑪 𝑰 𝑷 𝑨 𝑵 𝑻 𝑬 𝑺  𝑷 𝑶 𝑫 𝑬 𝑴  𝑬 𝑵 𝑽 𝑰 𝑨 𝑹  𝑴 𝑬 𝑵 𝑺 𝑨 𝑮 𝑬 𝑵 * `,
					contextInfo: { mentionedJid: [sender] }
					}
					...
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('error', function (err) {
								...
								reply(`⚠️𝑭 𝑨 𝑳 𝑯 𝑶 𝑼  𝑵 𝑨  𝑪 𝑶 𝑵 𝑽 𝑬 𝑹 𝑺 Ã𝑶  𝑫 𝑬   ${tipe} 𝑷 𝑨 𝑹 𝑨  𝑺 𝑻 𝑰 𝑪 𝑲 𝑬 𝑹 `)
							})
							.on('end', function () {
								console.log('Finish')
				...
				case 'toimg':
				    client.updatePresence(from, Presence.composing)
                                    if (!isUser) return reply(mess.only.daftarB)
					if (!isQuotedSticker) return reply('⚠️𝑨 𝑷 𝑬 𝑵 𝑨 𝑺  𝑺 𝑻 𝑰 𝑪 𝑲 𝑬 𝑹 𝑺 ⚠️')
					reply(mess.wait)
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						fs.unlinkSync(media)
						if (err) return reply('⚠️𝑯 𝑶 𝑼 𝑽 𝑬  𝑼 𝑴 𝑨  𝑭 𝑨 𝑳 𝑯 𝑨  𝑵 𝑨  𝑪 𝑶 𝑵 𝑽 𝑬 𝑹 𝑺 Ã𝑶  𝑫 𝑬  𝑺 𝑻 𝑰 𝑪 𝑲 𝑬 𝑹  𝑷 𝑨 𝑹 𝑨  𝑰 𝑴 𝑨 𝑮 𝑬 𝑴 ⚠️')
                	...
                	client.updatePresence(from, Presence.composing) 
                        if (!isUser) return reply(mess.only.daftarB)
					if (!isQuotedVideo) return reply('⚠️𝑹 𝑬 𝑺 𝑷 𝑶 𝑵 𝑫 𝑬 𝑹  𝑪 𝑶 𝑴  𝑽 𝑰 𝑫 𝑬 𝑶  𝑻 𝑰 𝑶 ⚠️')
					reply(mess.wait)
					encmedia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					media = await client.downloadAndSaveMediaMessage(encmedia)
					ran = getRandom('.mp4')
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						fs.unlinkSync(media)
						if (err) return reply('⚠️𝑯 𝑶 𝑼 𝑽 𝑨  𝑼 𝑴 𝑨  𝑭 𝑨 𝑳 𝑯 𝑨  𝑵 𝑨  𝑬 𝑿 𝑻 𝑹 𝑨 ÇÃ𝑶  𝑫 𝑶  𝑨 𝑼 𝑫 𝑰 𝑶  𝑫 𝑶  𝑽 Í𝑫 𝑬 𝑶⚠️ ')
						buffer = fs.readFileSync(ran)
                ...
                case 'ninjalogo':
                      if (args.length < 1) return reply('𝑪 𝑨 𝑫 𝑬  𝑨  𝑭 𝑹 𝑨 𝑺 𝑬 ?')
                      if (!isUser) return reply(mess.only.daftarB)
                      gh = body.slice(11)
                      gl1 = gh.split("|")[0];
                      gl2 = gh.split("|")[1];
               ...
               if (anu.error) return reply(anu.error)
                ...
                break
                   ...
                   break
					...
					break
                                  case 'daftar':
					client.updatePresence(from, Presence.composing)
					if (isUser) return reply('𝑽 𝑶 𝑪 𝑬  𝑱 Á 𝑬 𝑺 𝑻 𝑨  𝑹 𝑬 𝑮 𝑰 𝑺 𝑻 𝑹 𝑨 𝑫 𝑶  𝑴 𝑨 𝑵 𝑰 𝑵 🥰')
					...
					if (args.length < 1) return reply('⚠️️𝑷 𝑨 𝑹 𝑨  𝑨 𝑻 𝑰 𝑽 𝑨 𝑹  𝑫 𝑰 𝑮 𝑰 𝑻 𝑬  1⚠️')
					if (Number(args[0]) === 1) {
						if (isWelkom) return reply('⚠️𝑶  𝑹 𝑬 𝑪 𝑼 𝑹 𝑺 𝑶  𝑫 𝑬  𝑩 𝑶 𝑨 𝑺  𝑽 𝑰 𝑵 𝑫 𝑨 𝑺  𝑱 𝑨  𝑬 𝑺 𝑻 𝑨  𝑨 𝑻 𝑰 𝑽 𝑶 ️⚠️')
						welkom.push(from)
						fs.writeFileSync('./database/json/welkom.json', JSON.stringify(welkom))
						reply('「𝑺 𝑼 𝑪 𝑬 𝑺 𝑺 𝑶 」𝐀 𝐎  𝐀 𝐓 𝐈 𝐕 𝐀 𝐑  𝐎  𝐑 𝐄 𝐂 𝐔 𝐑 𝐒 𝐎  𝐃 𝐄  𝐁 𝐎 𝐀 𝐒  𝐕 𝐈 𝐍 𝐃 𝐀 𝐒  𝐍 𝐄 𝐒 𝐒 𝐄  𝐆 𝐑 𝐔 𝐏 𝐎 ')
					} else if (Number(args[0]) === 0) {
						welkom.splice(from, disable)
						fs.writeFileSync('./database/json/welkom.json', JSON.stringify(welkom))
						reply('「𝑺 𝑼 𝑪 𝑬 𝑺 𝑺 𝑶 」𝐀 𝐎  𝐃 𝐄 𝐒 𝐀 𝐓 𝐈 𝐕 𝐀 𝐑  𝐎  𝐑 𝐄 𝐂 𝐔 𝐑 𝐒 𝐎  𝐃 𝐄  𝐁 𝐎 𝐀 𝐒  𝐕 𝐈 𝐍 𝐃 𝐀 𝐒  𝐍 𝐄 𝐒 𝐒 𝐄  𝐆 𝐑 𝐔 𝐏 𝐎 ')
					} else {
					...
					if (args.length < 1) return reply(mess.blank)
                                        if (!isUser) return reply(mess.only.daftarB)
					tels = body.slice(7)
					if (tels.length > 15) return reply('𝑶  𝑻 𝑬 𝑿 𝑻 𝑶  É 𝑴 𝑼 𝑰 𝑻 𝑶  𝑮 𝑹 𝑨 𝑵 𝑫 𝑬  𝑻 𝑰 𝑶 , 𝑴 𝑨 𝑿 𝑰 𝑴 𝑶  20 𝑪 𝑨 𝑹 𝑨 𝑪 𝑻 𝑬 𝑹 𝑬 𝑺 ')
					reply(mess.wait)
				...
				case 'firetext':
					if (args.length < 1) return reply(mess.blank)
                                        if (!isUser) return reply(mess.only.daftarB)
					tels = body.slice(7)
					if (tels.ength > 10) return reply('𝑶  𝑻 𝑬 𝑿 𝑻 𝑶  É 𝑴 𝑼 𝑰 𝑻 𝑶  𝑮 𝑹 𝑨 𝑵 𝑫 𝑬  𝑻 𝑰 𝑶 , 𝑴 𝑨 𝑿 𝑰 𝑴 𝑶  9 𝑪 𝑨 𝑹 𝑨 𝑪 𝑻 𝑬 𝑹 𝑬 𝑺 ')
					reply(mess.wait)
				...
				if (isUser) return reply(mess.only.daftarB)
					...
					break
                                case 'nsfwneko':
				    try{
						if (!isNsfw) return reply('⚠️𝑶  𝑹 𝑬 𝑪 𝑼 𝑹 𝑺 𝑶  𝑵 𝑺 𝑭 𝑾  𝑵 𝑨 𝑶  𝑬 𝑺 𝑻 𝑨  𝑨 𝑻 𝑽 𝑰 𝑶⚠️ ')
                                                if (!isUser) return reply(mess.only.daftarB)
				...
				case 'logowolf':
					...
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (args.length < 1) return reply('⚠️𝐃 𝐈 𝐆 𝐈 𝐓 𝐄  1 𝐏 𝐀 𝐑 𝐀  𝐀 𝐓 𝐈 𝐕 𝐀 𝐑 ⚠️')
					if (Number(args[0]) === 1) {
						if (isNsfw) return reply('⚠️𝐎  𝐑 𝐄 𝐂 𝐔 𝐑 𝐒 𝐎  𝐄 𝐒 𝐓 𝐀  𝐀 𝐓 𝐈 𝐕 𝐎 ⚠️')
						nsfw.push(from)
						fs.writeFileSync('./database/json/nsfw.json', JSON.stringify(nsfw))
						reply('「𝑺 𝑼 𝑪 𝑬 𝑺 𝑺 𝑶 」𝑨 𝑻 𝑰 𝑽 𝑨 𝑫 𝑶  𝑹 𝑬 𝑪 𝑼 𝑹 𝑺 𝑶  𝑵 𝑺 𝑭 𝑾  𝑵 𝑬 𝑺 𝑺 𝑶  𝑮 𝑹 𝑼 𝑷 𝑶 ⚠️')
					} else if (Number(args[0]) === 0) {
						nsfw.splice(from, 1)
						fs.writeFileSync('./database/json/nsfw.json', JSON.stringify(nsfw))
						reply('「𝑺 𝑼 𝑪 𝑬 𝑺 𝑺 𝑶 」𝑫 𝑬 𝑺 𝑨 𝑻 𝑰 𝑽 𝑨 𝑫 𝑶   𝑹 𝑬 𝑪 𝑼 𝑹 𝑺 𝑶  𝑵 𝑺 𝑭 𝑾  𝑵 𝑬 𝑺 𝑺 𝑶  𝑮 𝑹 𝑼 𝑷 ⚠️')
					} else {
						reply('⚠️𝑫 𝑰 𝑮 𝑰 𝑻 𝑬  1 𝑷 𝑨 𝑹 𝑨  𝑨 𝑻 𝑰 𝑽 𝑨 𝑹 , 𝑬  0 𝑷 𝑨 𝑹 𝑨  𝑫 𝑬 𝑺 𝑨 𝑻 𝑰 𝑽 𝑨 𝑹⚠️ ')
					}
					break	
				case 'bucin':
            ...
            case 'leveling':
                if (!isGroup) return reply(mess.only.group)
                if (!isGroupAdmins) return reply(mess.only.admin)
                if (args.length < 1) return reply('⚠️𝑫 𝑰 𝑮 𝑰 𝑻 𝑬  1 𝑷 𝑨 𝑹 𝑨  𝑨 𝑻 𝑰 𝑽 𝑨 𝑹 ⚠️')
                if (args[0] === '1') {
                    if (isLevelingOn) return reply('⚠️𝑶  𝑹 𝑬 𝑪 𝑼 𝑹 𝑺 𝑶  𝑫 𝑬  𝑳 𝑬 𝑽 𝑬 𝑳  𝑱 𝑨  𝑬 𝑺 𝑻 𝑨  𝑨 𝑻 𝑰 𝑽 𝑶 ⚠️')
            ...
            break
                                ...
                                case 'nsfwtrap':
                                        try{
                                                if (!isNsfw) return reply('⚠️𝑵 𝑺 𝑭 𝑾  𝑵 𝑨 𝑶  𝑨 𝑻 𝑰 𝑽 𝑶⚠️ ')
                                                if (!isUser) return reply(mess.only.daftarB)
					...
					case 'nsfwarmpits':
				        ...
				        uptime = process.uptime()
                                ...
                                case 'neonlogo':
                                        var gh = body.slice(9)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}neonlogo KIRITO MAIS BRABO`)
                                        reply(mess.wait)
                                ...
                                case 'neonlogo2':
                                        ...
                                        teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}neonlogo2 KIRITO MAIS BRABO`)
                                        reply(mess.wait)
                                ...
                                case 'lionlogo':
                                        ...
                                        var teks1 = gh.split("|")[0];
                                        var teks2 = gh.split("|")[1];
                                        if (args.length < 1) return reply(`teksnya mana um\nContoh: ${prefix}lionlogo KIRITO O MAIS BRABO`)
                                        reply(mess.wait)
                                ...
                                case 'jokerlogo':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}jokerlogo KIRITO MAIS BRABO`)
                                        reply(mess.wait)
			       ...
			       reply(anu.result.jadwalTV)
					break
                                ...
                                case 'shadow':
                                        var gh = body.slice(7)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}shadow KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'burnpaper':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}burnpaper KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'coffee':
                                        var gh = body.slice(7)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}coffee KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'lovepaper':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}lovepaper KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'woodblock':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}woodblock KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'qowheart':
                                        var gh = body.slice(9)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}qowheart KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'mutgrass':
                                        var gh = body.slice(9)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}mutgrass KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'undergocean':
                                        var gh = body.slice(12)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}undergocean KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'woodenboards':
                                        ...
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}esqueci kkk KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'wolfmetal':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}wolfmetal KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'metalictglow':
                                        ...
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}metalictglow KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case '8bit':
                                        ...
                                        var teks1 = gh.split("|")[0];
                                        var teks2 = gh.split("|")[1];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}8bit KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'randomkpop':
                                        ...
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'CREDO COREANO GAY🤮'})
                                        break
                                case 'fml2':
                                        ...
                                        break
                                case 'tiktok':
					if (args.length < 1) return reply('𝑶 𝑵 𝑫 𝑬  𝑬 𝑺 𝑻 𝑨  𝑶  𝑳 𝑰 𝑵 𝑲 ?')
					...
					break
				case 'ttp':
					if (args.length < 1) return reply('𝑶 𝑵 𝑫 𝑬  𝑬 𝑺 𝑻 𝑨  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?')
					ranp = getRandom('.png')
					rano = getRandom('.webp')
				...
				case 'simih':
					...
					if (Number(args[0]) === 1) {
						if (isSimi) return reply('𝑶  𝑴 𝑶 𝑫 𝑶  𝑺 𝑰 𝑴 𝑰  𝑱 𝑨  𝑬 𝑺 𝑻 𝑨  𝑨 𝑻 𝑰 𝑽 𝑶  𝑵 𝑬 𝑺 𝑺 𝑬  𝑮 𝑹 𝑼 𝑷 𝑶 ')
						samih.push(from)
						fs.writeFileSync('./src/simi.json', JSON.stringify(samih))
						reply('「𝑺 𝑼 𝑪 𝑬 𝑺 𝑺 𝑶 」𝑨 𝑶  𝑨 𝑻 𝑰 𝑽 𝑨 𝑹  𝑴 𝑶 𝑫 𝑶  𝑺 𝑰 𝑴 𝑰  𝑵 𝑬 𝑺 𝑺 𝑬  𝑮 𝑹 𝑼 𝑷 𝑶 ')
					} else if (Number(args[0]) === 0) {
						samih.splice(from, 1)
						fs.writeFileSync('./src/simi.json', JSON.stringify(samih))
						reply('「𝑺 𝑼 𝑪 𝑬 𝑺 𝑺 𝑶 」𝑨 𝑶  𝑫 𝑬 𝑺 𝑨 𝑻 𝑰 𝑽 𝑨 𝑹   𝑴 𝑶 𝑫 𝑶  𝑺 𝑰 𝑴 𝑰  𝑵 𝑬 𝑺 𝑺 𝑬  𝑮 𝑹 𝑼 𝑷 𝑶 ️')
					} else {
						reply('𝑫 𝑰 𝑮 𝑰 𝑻 𝑬  1 𝑷 𝑨 𝑹 𝑨  𝑨 𝑻 𝑰 𝑽 𝑨 𝑹  𝑬  0 𝑷 𝑨 𝑹 𝑨  𝑫 𝑬 𝑺 𝑨 𝑻 𝑰 𝑽 𝑨 𝑹 ')
					}
					break
				case 'clone':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (args.length < 1) return reply('𝑻 𝑨 𝑮  𝑨 𝑳 𝑽 𝑶  𝑸 𝑼 𝑬  𝑽 𝑶 𝑪 Ê 𝑫 𝑬 𝑺 𝑬 𝑱 𝑨  𝑪 𝑳 𝑶 𝑵 𝑨 𝑬 ')
					...
					break
                                ...
                                case 'pubglogo':
                                        ...
                                        var teks1 = gh.split("|")[0];
                                        var teks2 = gh.split("|")[1];
                                        if (args.length < 1) return reply(`𝑪 𝑨 𝑫 𝑬  𝑶  𝑻 𝑬 𝑿 𝑻 𝑶 ?\n𝑬 𝑿 𝑬 𝑴 𝑷 𝑳 𝑶 : ${prefix}pubglogo KIRITO MAIS BRABO`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        ...
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: '𝑨 𝑸 𝑼 𝑰  𝑬 𝑺 𝑻 𝑨  𝑺 𝑼 𝑨  𝑳 𝑶 𝑮 𝑶 ...'})
                                        break
                                case 'herrypotter':
                                case 'harrypotter':
                                        var gh = body.slice(12)
